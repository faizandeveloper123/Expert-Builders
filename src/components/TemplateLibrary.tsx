...
const TEMPLATES: FormTemplate[] = [
  ...
  },
  {
    ...
    isFavorite: false,
    isMine: true,
    image: buildBrandHeaderImage('DEALERSHIP REGISTRATION'),
    accentColor: 'bg-[#0A58A3]',
